...
async def login():
    ...
    # Use API_BASE_URL env var (set in Railway Dashboard) so redirect_uri
    # matches what's registered in GitHub OAuth App, even when the request
    # arrives via Vercel rewrites.
